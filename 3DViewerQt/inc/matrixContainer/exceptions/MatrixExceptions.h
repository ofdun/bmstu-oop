...
public:
    InvalidInitSizeException(const char *filename,
                             ...
                             int line,
                             time_t time,
                             const char *text = "Could not create mathematical matrix with given rows and columns!") :
        BaseException(filename, funcName, line, time, text)
    {
    }
};
...
public:
    IncompatibleSizeException(const char *filename,
                              ...
                              int line,
                              time_t time,
                              const char *text = "Operation with such dimensions is not possible!") : BaseException(
...
public:
    NotInvertibleException(const char *filename,
                           ...
                           int line,
                           time_t time,
                           const char *text = "Matrix is not invertible!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
...
public:
    InvalidRowIndexException(const char *filename,
                             ...
                             int line,
                             time_t time,
                             const char *text = "Invalid row index!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
...
public:
    InvalidColumnIndexException(const char *filename,
                                ...
                                int line,
                                time_t time,
                                const char *text = "Invalid column index!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
...
public:
    MemoryAllocationException(const char *filename,
                              ...
                              int line,
                              time_t time,
                              const char *text = "Could not allocate enough memory for a matrix!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
...
public:
    InvalidInitializerListException(const char *filename,
                                    ...
                                    int line,
                                    time_t time,
                                    const char *text = "Invalid initializer list for a matrix!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
...
public:
    ImpossibleToMultiplyException(const char *filename,
                                  ...
                                  int line,
                                  time_t time,
                                  const char *text = "Impossible to multiply such matrices!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
...
public:
    ImpossibleToDivideException(const char *filename,
                                ...
                                int line,
                                time_t time,
                                const char *text = "Impossible to divide such matrices!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
...
public:
    NullptrArrayException(const char *filename,
                          ...
                          int line,
                          time_t time,
                          const char *text = "Can not create matrix from nullptr!") : BaseException(
        filename, funcName, line, time, text)
    {
    }
};
